...
class ImageScaler(tfk.models.Model):
    ...
    def __init__(
        ...
        self.intensity_noise_factor = 1.0
        self.metadata_noise_factor = 0.1
    ...
    def call(self, inputs, mc_samples=32, training=None, **kwargs):
        ...
        noise = self.intensity_noise_factor * iobs.with_flat_values(
            tf.random.normal(
                tfk.backend.shape(iobs.flat_values)
            )
        )
        inoised = iobs + sigiobs * noise
